...
-- 2022-05-28,JHarrod,Created File
--**************************************************************************--
Begin Try
	Use Master;
	If Exists(Select Name From SysDatabases Where Name = 'Assignment07DB_JHarrod')
	 Begin 
	  Alter Database [Assignment07DB_JHarrod] set Single_user With Rollback Immediate;
	  Drop Database Assignment07DB_JHarrod;
	 End
	Create Database Assignment07DB_JHarrod;
End Try
Begin Catch
	Print Error_Number();
End Catch
go
Use Assignment07DB_JHarrod;
...
Select
	CategoryName
	,ProductName
	,Format(UnitPrice, 'C', 'eng-US') As UnitPrice
...
Create or Alter  --Drop
View dbo.vProductInventoriesWithPreviousMonthCounts
As
Select Top 1000000
	ProductName
	,InventoryDate
	,[Count] as InventoryCount
	,[PreviousMonthCount] = IsNull(Lag([Count]) Over (Partition By ProductName Order By Month(InventoryDate),[Count]), 0)
...
Select Top 100000
	...
	,InventoryDate
	,InventoryCount
	,[PreviousMonthCount] = IsNull(Lag(InventoryCount) Over (Partition By ProductName Order By Month(InventoryDate),InventoryCount), 0)
